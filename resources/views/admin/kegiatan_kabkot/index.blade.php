...
@section('content')
    <div class="row mt-5">
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <button class="btn btn-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#tambahKegiatan">+
                        Kegiatan Kab/Kota</button>
        ...
        <div class="modal-dialog modal-dialog mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form method="POST" class="form" action="{{ route('kegiatan.kabkot.store') }}"
                        ...
                        <div class="mb-10">
                            <label for="required" class="form-label required">Provinsi  <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                title="Wajib"></i></label>
                            <select class="form-select form-select-solid" id="provinsi" name="provinsi_id" data-control="select2" data-dropdown-parent="#tambahKegiatan" data-placeholder="Pilih Provinsi" data-allow-clear="true" required>
                                <option></option>
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-select form-select-solid" id="kabupaten_kota" name="kabupaten_id" data-control="select2" data-dropdown-parent="#tambahKegiatan" data-placeholder="Pilih Kabupaten/Kota" data-allow-clear="true">
                                <option></option>
                            </select>
                        </div>
                        ...
                        <div class="mb-10">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                    title="Masukkan Jenis Kegiatan"></i>
                            </label>
                            <div class="d-flex">
    ...
    <div class="modal fade" id="fileKegiatan" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form method="POST" class="form" action="{{ route('kegiatan.kabkot.file.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">File Kegiatan</h1>
                        </div>
...
$("#kt_daterangepicker_1").daterangepicker();
        ...
        function fileData(id) {
            ...
            $.ajax({
                url: "{{ route('kegiatan.kabkot.file.edit') }}",
                method: "POST",
                data: {
                    _token: _token,
                    id: id
        ...
        function alertHapusFile(id) {
            ...
            var _token = "{{ csrf_token() }}";
            $.ajax({
                url: "{{ route('kegiatan.kabkot.file.destroy') }}",
                method: "POST",
                data: {
                    _token: _token,
                    id: id
        ...
        function hapus(id) {
            var _token = "{{ csrf_token() }}";
            $.ajax({
                url: "{{ route('kegiatan.kabkot.destroy') }}",
                method: "POST",
                data: {
                    _token: _token,
                    id: id
